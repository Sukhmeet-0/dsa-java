...
public class DeletingElementIn2DArray {
    static int [][]a=null;
    ...
    static void delete(int r,int c){
        if(a[r][c]!=Integer.MIN_VALUE){//--------------->O(1)
            a[r][c]=Integer.MIN_VALUE;//--------------->O(1)
            System.out.println("Element deleted successfully!!");//--------------->O(1)
        }
        else{
            System.out.println("No element present");//--------------->O(1)
        }
        System.out.println(Arrays.deepToString(a));//--------------->O(1)
    }
}
